...
object CharAppend:
  final class ToString(val charset: Charset) extends CharAppend[ToString]:
    ...
    override def append(ch: Char): ToString =
      buffer.append(ch); this
    override def append(str: String): ToString =
      buffer.append(str); this
    override def append(str: String, startIndex: Int, endIndex: Int): ToString =
      buffer.append(str `substring` (startIndex, endIndex)); this
    override def raw(str: String): ToString =
      buffer.append(str); this
